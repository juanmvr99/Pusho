...
export default class Header extends React.Component {
  render() {
    var width = Dimensions.get('window').width; //ancho de la pantalla
    return (
          <View> 
          {/*los rectangulos empiezan separados del view mas abajo pero no se porq (el View si inicia al principio del display)*/}
            <BlackRectangle width={width} height={366} viewBox='0 0 414 366' style={{position:'absolute', top:25}} />
            <PurpleRectangle width={width} height={366} viewBox='0 0 414 366' />
